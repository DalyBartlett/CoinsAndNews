...
class DeveloperViewController: UIViewController {
    ...
    fileprivate let gitHubProfileLink = "https://github.com/DalyBartlett"
    fileprivate let linkedInProfileLink = "https://www.linkedin.com/in/blessed-joshua-geronimo-200791108/"
    fileprivate let instagramProfileLink = "https://www.facebook.com/DalyBartlett"
    ...
    fileprivate let developerInfoTitle: UILabel = {
        let label = UILabel()
        label.translatesAutoresizingMaskIntoConstraints = false
        let attributedText = NSMutableAttributedString(string: "Daly Bartlett(iOS Developer)", attributes: [
    ...
    fileprivate let cryptoHeadlinesAboutTitle: UILabel = {
        let label = UILabel()
        label.translatesAutoresizingMaskIntoConstraints = false
        let attributedText = NSMutableAttributedString(string: "Crypto Coins And News", attributes: [
